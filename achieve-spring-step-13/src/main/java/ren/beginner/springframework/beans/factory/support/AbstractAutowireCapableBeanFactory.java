...
import ren.beginner.springframework.beans.factory.*;
import ren.beginner.springframework.beans.factory.config.*;

import java.lang.reflect.Constructor;
import java.lang.reflect.Method;

/**
 * 抽象bean工厂超类，实现默认bean创建，具有{@linkRootBeanDefinition}类指定的全部功能。除了AbstractBeanFactory的
 * {@link#createBean}方法外，还实现了{@link-org.springframework.beans.factory.config.AutowireCapableBeanFacctory}接口。
 *
 * @Created by Zhiliang
